...
print_usage :: proc() {
	...
	fmt.println("    upgrade     Upgrade Zephyr itself")
	...
	fmt.println("    zephyr -v                    # Show version (short)")
	fmt.println("    zephyr --version             # Show version (full)")
	fmt.println("    zephyr --verbose load        # Load modules with verbose output")
